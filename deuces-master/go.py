...
print ("The board: " + Card.print_pretty_cards(board))

print ("Player 1's cards:" + Card.print_pretty_cards(player1_hand))

print ("Player 2's cards:" + Card.print_pretty_cards(player2_hand))
